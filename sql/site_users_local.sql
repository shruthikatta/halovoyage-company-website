-- Local MySQL bootstrap (matches includes/db.local.php default database).
CREATE DATABASE IF NOT EXISTS `halovoyage` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `halovoyage`;
